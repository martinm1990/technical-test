...
class CreateSuperHeroUseCaseImplTest {
    ...
    @Test
    void ifCreateSuperHeroIsOk_thenReturnSuperHero(){
        //Given

        var superHero = SuperHero.builder().name("Flash").age(27).skill("move much faster").build();
        var savedSuperHero = SuperHero.builder().id(3L).name("Flash").age(27).skill("move much faster").build();
